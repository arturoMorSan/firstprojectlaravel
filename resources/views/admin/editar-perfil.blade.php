                    ...
                    <div class="md:row">
                        <div class="md:col-2/3">
                            ...
                            <div class="form-control">
                                ...
                                <text-field name="name" v-model="fields.name" maxlength="60" initial="{{ $authUser->name }}"></text-field>
                            ...
                            <div class="form-control">
                                ...
                                <text-field name="last_name" v-model="fields.last_name" maxlength="60" initial="{{ $authUser->last_name }}"></text-field>
